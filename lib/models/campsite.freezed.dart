...
class _$CampsiteImpl extends _Campsite {
  ...
  @override
  String toString() {
    return 'Campsite(id: $id, label: $label, photo: $photo, geoLocation: $geoLocation, isCloseToWater: $isCloseToWater, isCampFireAllowed: $isCampFireAllowed, hostLanguages: $hostLanguages, pricePerNight: $pricePerNight, createdAt: $createdAt)';
  }
